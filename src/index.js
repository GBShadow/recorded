...
createServer(async (request, response) => {
  ...
  const ffmpegProcess = spawn(
    ...
    [
      ...
      "mp4",
      "-vf",
      "monochrome,drawtext=text='gbs.shadow@gmail.com':x=10:y=H-th-10:fontsize=50:fontcolor=yellow:shadowcolor=black:shadowx=5:shadowy=5",
      "pipe:1",
    ],
    {
  ...
  request.once("close", () => {
    ...
    console.log("disconnect!", ffmpegProcess.kill());
  });
